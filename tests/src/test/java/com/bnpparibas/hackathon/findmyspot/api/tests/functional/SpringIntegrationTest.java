...
import com.bnpparibas.hackathon.findmyspot.api.tests.functional.main.TestsApplication;

//@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = TestsApplication.class, loader = SpringBootContextLoader.class)
@WebAppConfiguration
@SpringBootTest
